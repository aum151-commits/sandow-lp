 ...
 * кикбоксинг» — 51 показ), но в конце статей нет ни оффера, ни кнопки —
 * человек дочитывает и уходит. Блок ниже ставится ТОЛЬКО на страницах
 * без формы, то есть на статьях; коммерческие лендинги не трогаем, там
 * форма и прилипающая кнопка уже есть.
 *
...
(function () {
  ...
  function блок_в_конце() {
    ...
    // на коммерческих лендингах форма уже есть — второй призыв там лишний
